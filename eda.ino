...
void loop() {
  ...
  conductance = 1000000 * conductance;

  
   if (conductance >= 75000000) {
    Serial.println(conductance);
    Serial.println("Abnormal value: Conductance is above 75 micro siemens");
  } else {
    // Print the adjusted conductance
    Serial.println(conductance);
    Serial.println("normal value: Conductance is below 75 micro siemens");
  }
